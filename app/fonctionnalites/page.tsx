...
function DossierMockup() {
  ...
  return (
    <div ref={ref} className="aspect-[4/3] rounded-safe-md border border-white/5 bg-[var(--safe-mid-dark)]/30 overflow-hidden p-4 md:p-6">
      {/* Top bar */}
      <motion.div
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-semibold text-[var(--safe-white)] font-sans">Dossiers actifs</span>
        </div>
        <div className="px-2 py-0.5 rounded-full bg-[var(--safe-sage)]/15 text-xs text-[var(--safe-sage)] font-sans">47 dossiers</div>
      </motion.div>
      ...
      {[
        ...
        <motion.div
          ...
          className="flex items-center justify-between py-2 px-3 mb-1.5 rounded-safe-sm bg-white/[0.03] border border-white/[0.04] hover:border-[var(--safe-sage)]/20 transition-colors"
        >
          <div className="flex items-center gap-3">
            <div className={`w-1.5 h-1.5 rounded-full ${item.color}`} />
            <div>
              <div className="text-xs font-medium text-[var(--safe-white)] font-sans">{item.name}</div>
              <div className="text-xs text-[var(--safe-text-muted)] font-sans">{item.type}</div>
            </div>
          </div>
          <span className="text-xs text-[var(--safe-text-muted)] font-sans">{item.status}</span>
        </motion.div>
      ))}
    </div>
  );
    ...
    <div ref={ref} className="aspect-[4/3] rounded-safe-md border border-white/5 bg-[var(--safe-mid-dark)]/30 overflow-hidden p-4 md:p-6">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-semibold text-[var(--safe-white)] font-sans">Facture #1048</span>
        </div>
        <motion.div
          initial={{ scale: 0 }}
          animate={inView ? { scale: 1 } : {}}
          transition={{ delay: d + 1.2, type: "spring", stiffness: 300 }}
          className="px-2 py-0.5 rounded-full bg-[var(--safe-sage)]/15 text-xs text-[var(--safe-sage)] font-sans font-semibold"
        >
          CONFORME B-1 r.5
        </motion.div>
      </motion.div>
      ...
      {[
        ...
        <motion.div
          ...
          className="flex items-center justify-between py-1.5 px-2 mb-1 text-xs font-sans"
        >
      ...
      >
        <div className="flex justify-between text-xs font-sans text-[var(--safe-text-muted)]">
        ...
        <motion.div
          ...
          className="flex justify-between text-xs font-sans font-bold text-[var(--safe-white)] pt-1 border-t border-white/10"
        >
    ...
    <div ref={ref} className="aspect-[4/3] rounded-safe-md border border-white/5 bg-[var(--safe-mid-dark)]/30 overflow-hidden p-4 md:p-6">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-semibold text-[var(--safe-white)] font-sans">Compte en fidéicommis</span>
        </div>
      </motion.div>
      ...
      <motion.div
        ...
        className="mb-3 p-3 rounded-safe bg-[var(--safe-accent)]/10 border border-[var(--safe-sage)]/15"
      >
        <div className="text-xs text-[var(--safe-sage)] font-sans mb-1">Solde total en fidéicommis</div>
        <div className="text-lg font-bold text-[var(--safe-white)] font-sans">47 250,00 $</div>
      </motion.div>
      ...
      {[
        ...
        <motion.div
          ...
          className="flex items-center justify-between py-2 px-2 mb-1 rounded-safe-sm bg-white/[0.03]"
        >
          <div className="flex items-center gap-2">
            <div className={`w-5 h-5 rounded-safe-sm ${tx.bg} flex items-center justify-center`}>
          ...
          <span className={`text-xs font-bold font-sans ${tx.amount.startsWith("+") ? "text-[var(--safe-sage)]" : "text-amber-400"}`}>{tx.amount}</span>
        </motion.div>
      ))}
      ...
      <motion.div
        ...
        className="mt-2 flex items-center gap-2 px-2 py-1.5 rounded-safe-sm border border-[var(--safe-sage)]/20 bg-[var(--safe-sage)]/5"
      >
        <Check className="w-3 h-3 text-[var(--safe-sage)]" />
        <span className="text-xs text-[var(--safe-sage)] font-sans font-medium">Piste d&apos;audit : toutes les transactions sont vérifiées</span>
      </motion.div>
    </div>
  );
}
    ...
    <div ref={ref} className="aspect-[4/3] rounded-safe-md border border-white/5 bg-[var(--safe-mid-dark)]/30 overflow-hidden p-4 md:p-6">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-semibold text-[var(--safe-white)] font-sans">Semaine du 7 avril 2026</span>
        </div>
      </motion.div>
      ...
      >
        {days.map((day) => (
          <div key={day} className="text-center text-xs text-[var(--safe-text-muted)] font-sans py-1">{day}</div>
        ))}
      </motion.div>
            ...
            {events
              ...
              .map((event, ei) => (
                <motion.div
                  ...
                  className={`${event.color}/20 border border-white/5 rounded-safe-sm p-1.5 mb-1`}
                  style={{ marginTop: `${event.row * 28}px` }}
                >
                  <div className={`w-1 h-1 rounded-full ${event.color} mb-0.5`} />
                  <div className="text-xs font-medium text-[var(--safe-white)] font-sans leading-tight">{event.label}</div>
                </motion.div>
              ))}
          </div>
        ))}
    ...
    <div ref={ref} className="aspect-[4/3] rounded-safe-md border border-white/5 bg-[var(--safe-mid-dark)]/30 overflow-hidden p-4 md:p-6">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-semibold text-[var(--safe-white)] font-sans">Rapport financier 2025-2026</span>
        </div>
      </motion.div>
      ...
      <div className="grid grid-cols-3 gap-2 mb-4">
        {[
          ...
          <motion.div
            ...
            className="p-2 rounded-safe-sm bg-white/[0.04] border border-white/[0.06]"
          >
            <div className="text-xs text-[var(--safe-text-muted)] font-sans">{kpi.label}</div>
            <div className="text-xs font-bold text-[var(--safe-white)] font-sans">{kpi.value}</div>
            <div className="text-xs text-[var(--safe-sage)] font-sans">{kpi.change}</div>
          </motion.div>
        ))}
      </div>
      ...
      <div className="flex justify-between">
        {["Jan", "Fév", "Mar", "Avr", "Mai", "Jun", "Jul", "Aoû", "Sep", "Oct", "Nov", "Déc"].map((m) => (
          <span key={m} className="text-xs text-[var(--safe-text-muted)] font-sans">{m}</span>
        ))}
      </div>
    </div>
  );
...
function AgentsIAMockup() {
  ...
  return (
    <div ref={ref} className="aspect-[4/3] rounded-safe-md border border-white/5 bg-[var(--safe-mid-dark)]/30 overflow-hidden p-4 md:p-6">
      ...
      >
        <div className="max-w-[80%] p-3 rounded-safe rounded-tr-sm bg-[var(--safe-accent)]/30 border border-[var(--safe-sage)]/15">
          <div className="text-xs text-[var(--safe-white)] font-sans">
      ...
      >
        ...
        <span className="text-xs text-[var(--safe-text-muted)] font-sans italic">Recherche dans 47 dossiers...</span>
      </motion.div>
      ...
      <motion.div
        ...
        className="max-w-[85%] p-3 rounded-safe rounded-tl-sm bg-white/[0.04] border border-white/[0.06]"
      >
        <div className="flex items-center gap-1.5 mb-1.5">
          <span className="text-xs">🤖</span>
          <span className="text-xs font-semibold text-[var(--safe-sage)] font-sans">Employé virtuel</span>
        </div>
        <div className="text-xs text-[var(--safe-white)]/80 font-sans leading-relaxed">
          {typedText}
      ...
      >
        ...
        <span className="text-xs text-[var(--safe-text-muted)] font-sans italic">L&apos;IA assiste, vous décidez. Aucun conseil juridique automatisé.</span>
      </motion.div>
    </div>
  );
}
          ...
          return (
            <section
              ...
              className={`relative py-20 lg:py-28 ${
                idx % 2 === 0 ? "section-dusk" : "section-night"
              }`}
            >
              <div className="landing-grain absolute inset-0 pointer-events-none" />
              <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-10">
                ...
                >
                  ...
                  >
                    <div className="w-14 h-14 rounded-safe-md bg-[var(--safe-accent)]/15 border border-[var(--safe-sage)]/10 flex items-center justify-center mb-6">
                      <feat.icon className="w-7 h-7 text-[var(--safe-sage)]" />
                    </div>
                    <h2 className="font-sans text-3xl md:text-4xl text-[var(--safe-white)] mb-4 leading-tight tracking-tight">
                      {feat.title}
                    </h2>
                    <p className="text-[var(--safe-text-muted)] text-lg leading-relaxed mb-8 font-sans">
                      {feat.description}
                    </p>
                  ...
                  >
                    <div className="card-dark rounded-safe-md bg-[var(--safe-darkest)] p-1">
                    {MockupComponent ? <MockupComponent /> : (
                      <div className="aspect-[4/3] rounded-safe-md border border-white/5 bg-[var(--safe-mid-dark)]/30 flex items-center justify-center overflow-hidden">
        ...
        <section className="section-night relative py-20 lg:py-28">
          ...
          <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-10">
            <div className="text-center mb-16">
              <p className="text-lg font-sans italic text-emerald-400 mb-4">
                Et aussi...
              </p>
              <h2 className="font-sans text-3xl md:text-4xl text-white tracking-tight">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <motion.div
                  ...
                  className="group p-6 rounded-safe-md border border-white/[0.08] bg-white/[0.03] hover:border-white/[0.15] transition-all duration-500"
                >
