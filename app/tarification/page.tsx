...
const PLANS = [
  ...
  },
  {
    ...
    features: [
      ...
      "Conformité Loi 25 + PIPEDA",
      "Conformité FINTRAC (anti-blanchiment)",
      "Audit complet + alertes multi-barreaux",
  ...
  },
  {
    ...
    description: "Pour les cabinets établis qui exigent un support premium et une conformité pan-canadienne blindée.",
    features: [
...
const comparisonFeatures = [
  ...
  { name: "Facturation conforme (Barreau provincial)", solo: true, cabinet: true, cabinetPlus: true },
  { name: "Échéanciers & alertes judiciaires", solo: true, cabinet: true, cabinetPlus: true },
  { name: "Conformité Loi 25 (Québec)", solo: true, cabinet: true, cabinetPlus: true },
  { name: "Conformité PIPEDA (fédéral)", solo: true, cabinet: true, cabinetPlus: true },
  { name: "Conformité FINTRAC (anti-blanchiment)", solo: false, cabinet: true, cabinetPlus: true },
  { name: "Audit de conformité Barreau", solo: "Alertes", cabinet: "Complet + alertes", cabinetPlus: "Complet + pré-inspection certifié" },
  { name: "Support multi-barreaux (QC, ON, AB, C.-B.)", solo: false, cabinet: "Alertes", cabinetPlus: "Complet" },
...
const faqs = [
  ...
  },
  {
    ...
    a: "Toutes les données sont hébergées au Canada (Montréal et Toronto), chiffrées AES-256. Conforme à la Loi 25 (Québec) et à la PIPEDA (loi fédérale sur la protection des renseignements personnels).",
  },
  {
  ...
  },
  {
    ...
    a: "Oui. SAFE est conçu pour les avocats canadiens de toutes les provinces : facturation conforme aux règlements de votre Barreau provincial, gestion du fidéicommis, conformité Loi 25 + PIPEDA, obligations FINTRAC (anti-blanchiment), et audit pré-inspection intégré.",
  },
];
