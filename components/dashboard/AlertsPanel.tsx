  ...
  if (alerts.length === 0) {
    return (
      <div className="bg-white/70 backdrop-blur-sm rounded-2xl border border-white/60 shadow-[0_2px_16px_rgba(0,0,0,0.04)] p-6 md:p-7">
        <h3 className="text-base font-medium text-neutral-800 mb-4 flex items-center gap-2.5 tracking-tight">
        ...
        <div className="flex flex-col items-center py-8 text-center">
          ...
          <p className="text-sm font-medium text-neutral-700">{t("noAlerts")}</p>
  ...
  return (
    <div className="bg-white/70 backdrop-blur-sm rounded-2xl border border-amber-200/50 shadow-[0_2px_16px_rgba(0,0,0,0.04)] p-6 md:p-7">
      <h3 className="text-base font-medium text-neutral-800 mb-5 flex items-center gap-2.5 tracking-tight">
        ...
        {t("alerts")}
        <span className="ml-auto text-[11px] font-medium bg-amber-100 text-amber-700 px-2.5 py-1 rounded-full">
          {alerts.length}
        </span>
      </h3>
          ...
          <li key={`${alert.type}-${index}`}>
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <p className="text-sm font-medium text-neutral-700">{alert.type}</p>
