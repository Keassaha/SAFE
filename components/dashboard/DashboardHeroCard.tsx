  ...
  return (
    <div className="card-glass overflow-hidden p-5 md:p-6">
      <div className="flex items-start justify-between gap-2 mb-4">
        <div>
          <h3 className="text-sm font-semibold safe-text-title tracking-tight">{libelle}</h3>
          <p className="text-xs safe-text-secondary mt-0.5">SAFE</p>
        </div>
        <div className="w-9 h-9 rounded-safe-sm bg-green-100 flex items-center justify-center text-[var(--safe-icon-default)] shrink-0">
      ...
      <div className="flex items-center gap-2 mt-6">
        <Link
          href="/rapports"
          className="flex-1 flex flex-col items-center gap-1.5 py-2 rounded-safe-sm bg-green-50 border border-green-600/30 text-green-900 hover:bg-green-100 transition-colors text-xs font-medium"
        >
