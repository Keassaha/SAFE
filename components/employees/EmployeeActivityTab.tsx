            ...
            <table className="w-full text-sm" role="table">
              <thead>
                <tr className="border-b border-si-line bg-si-canvas/60">
                  <th className="px-4 py-3 text-left font-medium text-si-muted">{t("dateColumn")}</th>
                  <th className="px-4 py-3 text-left font-medium text-si-muted">{t("actionColumn")}</th>
                  <th className="px-4 py-3 text-left font-medium text-si-muted">{t("entityColumn")}</th>
                  <th className="px-4 py-3 text-left font-medium text-si-muted">{t("detailsColumn")}</th>
                </tr>
              </thead>
              <tbody>
                {activities.map((row) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-si-muted max-w-xs truncate">
                      {row.metadata ?? "—"}
                    </td>
                  </tr>
                ))}
