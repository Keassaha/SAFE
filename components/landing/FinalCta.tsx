...
export function FinalCta() {
  ...
  return (
    <section className="bg-[#0A0A0A] py-[80px] px-6 text-center w-full flex flex-col items-center">
      ...
      >
        Votre cabinet mérite <span className="italic text-forest-600">mieux que ça.</span>
      </motion.h2>
      ...
      <motion.p 
        ...
        className="text-[17px] text-[#A1A1A1] max-w-[540px] font-sans leading-[1.6] mb-10"
      >
        Faites votre audit gratuit. Recevez votre rapport personnalisé sous 24 heures. Aucun engagement.
      </motion.p>
      ...
      >
        ...
        <Button variant="primary" size="lg">Réserver un appel</Button>
      </motion.div>
