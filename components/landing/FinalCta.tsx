...
export function FinalCta() {
  ...
  return (
    <section className="bg-canvas border-t border-[0.5px] border-border py-[80px] px-6 text-center w-full flex flex-col items-center">
      ...
      >
        Sachez où vous en êtes, <span className="italic text-forest-600">noir sur blanc, avant qu&apos;on vous le demande.</span>
      </motion.h2>
      ...
      >
        Vous recevez un diagnostic complet : votre fidéicommis passé en revue point par point, et le portrait clair de la trésorerie immobilisée entre le travail livré et le paiement. Vous y trouvez votre situation actuelle et les corrections à prioriser pour vous remettre à jour.
      </motion.p>
